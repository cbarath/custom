			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("octannercockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("octannercockpits.product.externalTaxes"));
