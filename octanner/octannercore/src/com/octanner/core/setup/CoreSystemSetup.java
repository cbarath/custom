 ...
 */
@SystemSetup(extension = OctannerCoreConstants.EXTENSIONNAME)
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/octannercore/import/essential-data.impex");
		importImpexFile(context, "/octannercore/import/countries.impex");
		importImpexFile(context, "/octannercore/import/delivery-modes.impex");

		importImpexFile(context, "/octannercore/import/themes.impex");
	}
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/octannercore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/octannercore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/octannercore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/octannercore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/octannercore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/octannercore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/octannercore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/octannercore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/octannercore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/octannercore/import/mcc-sites-links.impex");
		}
	...
	public PerformResult executeCatalogSyncJob(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/octannercore/import/catalogs-sync.impex", true);
	...
	protected void importProductCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/octannercore/import/productCatalogs/" + catalogName + "ProductCatalog/catalog.impex",
				true);
	...
	protected void createAndActivateSolrIndex(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/octannercore/import/stores/" + storeName + "/solr.impex");

		createSolrIndexerCronJobs(storeName + "Index");

		importImpexFile(context, "/octannercore/import/stores/" + storeName + "/solrtrigger.impex");
	...
	protected void importContentCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/octannercore/import/contentCatalogs/" + catalogName + "ContentCatalog/catalog.impex",
				true);
		importImpexFile(context, "/octannercore/import/contentCatalogs/" + catalogName + "ContentCatalog/cms-content.impex",
				false);
		importImpexFile(context, "/octannercore/import/contentCatalogs/" + catalogName
	...
	protected void importStore(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/octannercore/import/stores/" + storeName + "/store.impex");
		importImpexFile(context, "/octannercore/import/stores/" + storeName + "/site.impex");
