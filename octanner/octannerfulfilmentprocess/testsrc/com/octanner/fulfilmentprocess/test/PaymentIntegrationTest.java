...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/octannerfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/octannerfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/octannerfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/octannerfulfilmentprocess/test/testCatalog.csv", "windows-1252");
